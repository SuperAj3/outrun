...
type SqlCompatiblePlayerState struct {
	...
	EventRewardID           int64  `json:"eventRewardID,string" db:"event_rewardid"`
}

func PlayerStateToSQLCompatiblePlayerState(ps PlayerState, ep, erid int64) SqlCompatiblePlayerState {
