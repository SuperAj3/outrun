	...
	if uid == "0" && password == "" {
		...
		if request.Version == "2.0.3" || request.Version == "2.1.1" && !config.CFile.LegacyCompatibilityMode {
			...
			err = helper.SendResponse(responses.NewNextVersionResponse(baseInfo,
				...
				0,
				"",
				"Sonic Runners Revival has been updated! This version of Revival is no longer supported.We semi-regularly update Sonic Runners Revival with new features and content that wouldn't be possible without app updates.\n\nDownload the new version here: https://www.sonicrunners.com/#/download\nOur Twitter: https://twitter.com/runnersrevival\nOur Discord: https://discord.gg/T5ytR6T",
				"Sonic Runners Revival has been updated! This version of Revival is no longer supported.We semi-regularly update Sonic Runners Revival with new features and content that wouldn't be possible without app updates.\n\nDownload the new version here: https://www.sonicrunners.com/#/download\nOur Twitter: https://twitter.com/runnersrevival\nOur Discord: https://discord.gg/T5ytR6T",
