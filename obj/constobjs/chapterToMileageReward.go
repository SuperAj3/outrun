...
// See enums/incentiveTypes.go for explanations of the mileage reward types

var AreaRewards = map[string][]obj.MileageReward{
	"1,1": []obj.MileageReward{
		// early episodes do not have mileage rewards at points.
	...
	"6,1": []obj.MileageReward{
		obj.NewMileageReward(enums.IncentiveTypeChapter, enums.ItemIDRing, 10000, 5), // using IncentiveTypeEpisode here causes the game to not show that reward
	...
	// beyond this point episodes will have rewards on the mileage map
